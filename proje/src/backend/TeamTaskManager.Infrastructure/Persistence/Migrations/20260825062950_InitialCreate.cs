        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Projects_TargetEndDate", "[TargetEndDate] >= [StartDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    MemberRole = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TaskItems_DueDate", "[StartDate] IS NULL OR [DueDate] >= [StartDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TaskAttachments_FileSize", "[FileSize] > 0 AND [FileSize] <= 5242880");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "01768d87-e963-4b77-b7da-b4a5916fbe46", "2f400038-b4ca-4d7d-b0fc-8e5dded4628d", "ProjectManager", "PROJECTMANAGER" },
                    { "7b3c2144-4d95-4b60-b35a-ecdbfcd66fb7", "e4c55be2-99b0-4542-96b7-6aaf7ec299a1", "Admin", "ADMIN" },
                    { "a74af48a-beb5-4de1-a93a-cc91545bb5de", "dc2934a0-7ea7-4354-b8f6-e690c4d5518c", "TeamMember", "TEAMMEMBER" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_EntityType_EntityId_CreatedDate",
                table: "ActivityLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectMembers_UserId_IsActive",
                table: "ProjectMembers",
                columns: new[] { "UserId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Projects_ManagerUserId_IsArchived_Status",
                table: "Projects",
                columns: new[] { "ManagerUserId", "IsArchived", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Projects_ManagerUserId_Name",
                table: "Projects",
                columns: new[] { "ManagerUserId", "Name" },
                unique: true,
                filter: "[IsArchived] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_TaskAttachments_TaskItemId_CreatedDate",
                table: "TaskAttachments",
                columns: new[] { "TaskItemId", "CreatedDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskComments_TaskItemId_CreatedDate",
                table: "TaskComments",
                columns: new[] { "TaskItemId", "CreatedDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_AssignedUserId_Status_DueDate",
                table: "TaskItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_ProjectId_Status_IsArchived",
                table: "TaskItems",
                columns: new[] { "ProjectId", "Status", "IsArchived" });
        }
